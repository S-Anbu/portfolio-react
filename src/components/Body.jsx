  ...
  return (
    <div className='grid grid-cols-3 grid-rows-1 gap-2 items-center justify-center   px-5 md:px-10 lg:px-36'>
      ...
      <div className='col-span-2'>
        <span className=' text-2xl md:text-5xl lg:text-7xl font-semibold md:block'>Hi,</span>
        <span className='text-2xl md:text-5xl lg:text-7xl font-semibold md:block'>I'm <span className='text-[#0d6efd] '>Anbarasan</span> </span>
        <span className='text-2xl md:text-5xl lg:text-7xl font-semibold'>Web Designer & Developer</span>
      </div>
